    ...
    return (
      <div>
        ...
        <Container text style={{ marginTop: '2em' }}>
          <Header as='h1'>DevOps</Header>
          <p>DevOps is the lastet hotspot word for software engineering as it keeps evolution.</p>
        </Container>
        ...
        >
          ...
          >
            <Container text>
              ...
              <Menu.Item header>Understand</Menu.Item>
              <Menu.Item as='a'>Implement</Menu.Item>
